...
//		String host = "localhost";
	...
	public static void runAssignment(String url, String username, String password){
		try{
			...
			System.out.println("Listing all persons who are both employees and customers of the bank.");
			...
			System.out.println("\nQuerying \"empLoan\" view. \n" +
					"Listing all persons who are both employees and customers of the bank.");
			ResultSet rs2 = stmt2.executeQuery(QUERY_2);
			System.out.println("Query 2 executed");
			while(rs2.next()){
				System.out.println("\ntaxPayerID: "+rs2.getString("taxPayerID"));
			...
			System.out.println("\nPreparing CallableStatement to call \"get_no_of_tran\" function.");
			...
			System.out.println("Calling get_no_of_tran(\"123456789\") ");
			cstmt3.execute();
			System.out.println("\nnumber of transactions for account \"123456789\" = "+cstmt3.getInt(1)+" transactions");
			cstmt3.close();
